...
La arquitectura de CUDA fue diseñada, para que la GPU pudiera ser utilizada en aplicaciones de propósito general. En la cual se tiene un arreglo de procesadores con múltiples unidades aritmético lógica, por sus siglas en ingles ALU, las cuales para alcanzar este objetivo, fueron diseñadas para poder operar operaciones de punto flotante cumpliendo los requisitos del Instituto de Ingeniería Eléctrica y Electrónica (IEEE).
